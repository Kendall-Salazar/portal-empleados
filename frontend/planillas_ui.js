...
async function generarPrestamo() {
    ...
    try {
        ...
        alert('âœ… Documento de Préstamo generado exitosamente.');
...
async function generarAmonestacion() {
    ...
    try {
        ...
        alert('âœ… Carta de Amonestación generada exitosamente.');
...
// â”€â”€ Liquidación (Despido / Renuncia) â”€â”€
...
// â”€â”€ Carta de Recomendación â”€â”€
...
async function generarRecomendacion() {
    ...
    try {
        ...
        alert('âœ… Carta de Recomendación generada exitosamente.');
